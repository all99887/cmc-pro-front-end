                    ...
                    <section class="cmc-table">
                        <el-table
                            ...
                            <el-table-column type="selection" width="55" align="left" :formatter="tableformatter"></el-table-column>
                                                        <el-table-column prop="userName" label="用户名" align="left" :formatter="tableformatter"></el-table-column>
                            <el-table-column prop="password" label="密码" align="left" :formatter="tableformatter"></el-table-column>
                            <el-table-column prop="createTime" label="创建时间" align="left" :formatter="tableformatter"></el-table-column>
                            <el-table-column prop="status" label="有效性" align="left" :formatter="tableformatter"></el-table-column>
